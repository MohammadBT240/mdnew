...
if (isset($_POST['submit'])) {
   switch ($_POST['submit']) {
      ...
      case 'applicant':
         ...
         $sql2 = "DELETE FROM applicants_id WHERE applicant_id = '$applicant_id'";
         $result = mysqli_query($con, $sql);
         $result2 = mysqli_query($con, $sql2);

         if ($result && $result2) {
            if ($app_class == "Executive") {
               header("location: ../../adashboard.php?status=Valid&message=Record%20Created%20Successfully");
            } else {
      ...
      case 'applicantUpdate':
         ...
         if ($result) {
            if ($MainApp = 'main') {
               header("location: ../../aapplicantUpdateView.php?applicant_id=$applicant_id&status=Valid&message=Record%20Updated%20Successfully");
            } else {
               header("location: ../../applicantUpdateView.php?applicant_id=$applicant_id&status=Valid&message=Record%20Updated%20Successfully");
            }
            exit(0);
         } else {
            if ($MainApp = 'main') {
               header("location: ../../aapplicantUpdateView.php?applicant_id=$applicant_id&status=Invalid&message=Record%20Not%20Updated");
            } else {
               header("location: ../../applicantUpdateView.php?applicant_id=$applicant_id&status=Invalid&message=Record%20Not%20Updated");
            }
            exit(0);
         }
