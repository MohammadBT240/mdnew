			...
			for ($j = 0, $jen = count($columns); $j < $jen; $j++) {
				...
				if (isset($column['formatter'])) {
					if (empty($column['db'])) {
						...
						if ($column['dt'] == 'concatenated') {
							// Concatenate two values as one
							$value1 = $data[$i]['value1']; // Replace 'value1' with the actual field name
							$value2 = $data[$i]['value2']; // Replace 'value2' with the actual field name
							$concatenatedValue = $value1 . ' ' . $value2;
							$row[$column['dt']] = $concatenatedValue;
						} else {
