               ...
               <div class="card card-custom">
                  <div class="card-header flex-wrap border-0 pt-6 pb-0">
                     <div class="card-title">
                        <h3 class="card-label">
                           <span class="d-block text-muted pt-2 font-size-sm">Registered Staff Reports.</span>
                        </h3>
                     </div>
   ...
   <script>
      $(document).ready(function() {
         $('#example').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "assets/php/fetch/fetch_staff.php",
            "columnDefs": [{
               "orderable": false,
               "targets": 7
            }],
   ...
   <script type="text/javascript">
      $(document).ready(function() {
         ...
         $('#confirmDelete').click(function() {
            if (recordId) {
               $.ajax({
                  url: 'assets/php/admin/delete_user.php',
                  method: 'POST',
                  data: {
                     id: recordId
                  },
