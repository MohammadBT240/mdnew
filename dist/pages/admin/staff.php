                        ...
                        <div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
                           ...
                           <div class="row">
                              <div class="offset-xxl-2 col-xxl-8">
                                 <form class="form" action="assets/php/conn.php" method="post" id="kt_form" enctype="multipart/form-data">
                                    <!--begin: Wizard Step 1-->
                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                          ...
                                          <div class="col-xl-6">
                                             ...
                                             <div class="row-xl-4">
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control form-control-solid form-control-lg" name="staff_id" placeholder="ID" value="" />
                                       ...
                                       <div class="row">
                                          <div class="col-xl-4">
                                             ...
                                             <div class="form-group">
                                                <label>Surname</label>
                                                <input type="tel" class="form-control form-control-solid form-control-lg" name="surname" placeholder="surname" value="" />
                                       ...
                                       <div class="modal-dialog">
                                          <div class="modal-content">
                                             ...
                                             <div class="modal-footer">
                                                ...
                                                <button type="submit" name="submit" value="staff" class="btn btn-success" data-bs-dismiss="modal">Submit</button>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
