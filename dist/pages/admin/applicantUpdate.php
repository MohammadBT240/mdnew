                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-xl-6">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <!-- <input type="file" class="form-control form-control-solid form-control-lg" name="id_photo" placeholder="" value="<?php echo $dispPhotoId; ?>" autocomplete="off" />
                                    ...
                                    <div class="row">
                                       <div class="col-xl-6">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" class="form-control form-control-solid form-control-lg" name="name_of_kin" placeholder="id" value="<?php echo $dispKinName; ?>" data-control="select2" />
