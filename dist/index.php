<?php
session_start();
// include("assets/php/seshMessage.php");
?>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
      ...
      <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('assets/media/bg/bg-3.jpg')">
        <div class="login-form text-center p-7 position-relative overflow-hidden">
          ...
          <div class="login-signin">
            ...
            <center>
              <div>
                <?php include("assets/php/seshMessage.php");  ?>
              </div>
            </center>
            <!-- id="kt_login_signin_form" -->
            <form class="form" method="post" action="assets/php/loginAuth.php">
              <div class="form-group mb-5">
                <input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Email" value="" name="username" autocomplete="off" />
              </div>
              <div class="form-group mb-5">
              ...
              <button name="submit" id="kt_login_signin_submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">
                Sign In
              </button>
            </form>
          </div>
  ...
  <script src="assets/js/pages/custom/login/login-general-mod.js"></script>
  <!--end::Page Scripts-->
  ...
  <script>
    $(document).ready(function() {
      ...
      <?php
      // Clear the session values to avoid showing the same message again
      ...
      //   }).then(function() {
      //     if (url !== '') {
      //       // Add session data as query parameters to the URL
      //       var redirectUrl = url + "?status=" + encodeURIComponent(status) + "&type=" + encodeURIComponent(type);
