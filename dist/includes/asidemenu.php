...
// $status = $_GET['status'];
$type = $_SESSION['type'];
include("assets/php/check_session.php");
...
if ($type != 'Applicant') {
   ...
   // echo $type . "";
   // echo $_SESSION['type'] . "Type Session";
...
<head>
   ...
   <!--begin::WIZARD-->
   <link href="assets/css/pages/wizard/wizard-2.css?v=7.0.6" rel="stylesheet" type="text/css" />
      ...
      <?php switch ($type) {
         case 'Admin': ?>
            ...
            <div class="brand flex-column-auto" id="kt_brand">
               <!--begin::Logo-->
               <a href="../dist/dashboard.php" class="brand-logo">
                  <img alt="Logo" src="assets/media/logos/logo-light.png" />
               </a>
               <!--end::Logo-->
               ...
               <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                  ...
                  <ul class="menu-nav">
                     <li class="menu-item" aria-haspopup="true">
                        <a href="../dist/dashboard.php" class="menu-link"><i class="menu-icon flaticon-home"></i><span class="menu-text">Dashboard</span></a>
                     </li>
                     ...
                     <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle"><i class="menu-icon flaticon-graphic"></i><span class="menu-text">Staffs</span><i class="menu-arrow"></i></a>
                        <div class="menu-submenu">
                           <i class="menu-arrow"></i>
                           <ul class="menu-subnav">
                              <li class="menu-item" aria-haspopup="true">
                                 <a href="staffCreateView.php" class="menu-link"><i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Create Record</span></a>
                              </li>
                              <li class="menu-item" aria-haspopup="true">
                                 <a href="staffReportView.php" class="menu-link"><i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Reports</span></a>
                              </li>
                           </ul>
                        </div>
                     </li>
                        ...
                        <div class="menu-submenu">
                           ...
                           <ul class="menu-subnav">
                              <li class="menu-item menu-item-parent" aria-haspopup="true">
                                 <span class="menu-link"><span class="menu-text"></span></span>
                              </li>
                              <li class="menu-item" aria-haspopup="true">
                                 <a href="applicantCreateView.php" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    <span class="menu-text">Create Records</span>
                                 </a>
                              </li>
                              <li class="menu-item" aria-haspopup="true">
                                 <a href="applicantReportView.php" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
         ...
         case 'Executive': ?>
            ...
            <div class="brand flex-column-auto" id="kt_brand">
               <!--begin::Logo-->
               <a href="../dist/edashboard.php" class="brand-logo">
                  <img alt="Logo" src="assets/media/logos/logo-light.png" />
               </a>
               <!--end::Logo-->
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
               ...
               <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                  ...
                  <ul class="menu-nav">
                     <li class="menu-item" aria-haspopup="true">
                        <a href="../dist/edashboard.php" class="menu-link"><i class="menu-icon flaticon-home"></i><span class="menu-text">Dashboard</span></a>
                     </li>
                     <li class="menu-section">
                        <h4 class="menu-text">PAGEs</h4>
                        <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                     ...
                     <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle"><i class="menu-icon flaticon-graphic"></i><span class="menu-text">Reports</span><i class="menu-arrow"></i></a>
                        <div class="menu-submenu">
                           <i class="menu-arrow"></i>
                           <ul class="menu-subnav">
                              <li class="menu-item" aria-haspopup="true">
                                 <a href="eapplicantReportView.php" class="menu-link"><i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Applicants Report</span></a>
                              </li>
                              <li class="menu-item" aria-haspopup="true">
                                 <a href="estaffReportView.php" class="menu-link"><i class="menu-bullet menu-bullet-dot"><span></span></i><span class="menu-text">Staffs Reports</span></a>
                              </li>
                           </ul>
                        </div>
                     </li>
         ...
         case 'Applicant':
            ...
            if (!$row) { ?>
               ...
               <div class="brand flex-column-auto" id="kt_brand">
                  <!--begin::Logo-->
                  <a href="../dist/adashboard.php" class="brand-logo">
                     <img alt="Logo" src="assets/media/logos/logo-light.png" />
                  </a>
                  <!--end::Logo-->
               ...
               <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                  ...
                  <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                     ...
                     <ul class="menu-nav">
                        <li class="menu-item" aria-haspopup="true">
                           <a href="../dist/adashboard.php" class="menu-link"><i class="menu-icon flaticon-home"></i><span class="menu-text">Dashboard</span></a>
                        </li>
                        <li class="menu-section">
                           <h4 class="menu-text">PAGEs</h4>
                           <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                           <a href="../dist/adashboard.php" class="menu-link"><i class="menu-icon flaticon-graphic"></i><span class="menu-text">Create Profile</span></a>
                        </li>
                     </ul>
                     <!--end::Menu Nav-->
                  </div>
               ...
               <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                  ...
                  <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                     ...
                     <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                           <a href="../dist/aapplicantUpdateView.php?applicant_id=<?php echo $_SESSION['applicant_id']; ?>" class="menu-link"><i class="menu-icon flaticon-graphic"></i><span class="menu-text">Edit Profile</span></a>
                        </li>
                     </ul>
                     <!--end::Menu Nav-->
                  </div>
      ...
      <?php switch ($type) {
         case 'Admin': ?>
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                     ...
                     <div class="navi mt-2">
                        <a href="#" class="navi-item">
                           <span class="navi-link p-0 pb-2">
                              ...
                              <span class="navi-text text-muted text-hover-primary"><?php echo $dispEmail; ?></span>
                           </span>
                        </a>

                        <a href="../dist/logout.php" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                     </div>
                  </div>
               </div>
               <!--end::Header-->
               ...
               <div class="navi navi-spacer-x-0 p-0">
                  <!--begin::Item-->
                  <a href="sprofileView.php" class="navi-item">
                     <div class="navi-link">
         ...
         case 'Executive': ?>
            ...
            <div class="offcanvas-content pr-5 mr-n5">
               ...
               <div class="navi navi-spacer-x-0 p-0">
                  <!--begin::Item-->
                  <a href="eprofileView.php" class="navi-item">
                     <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                           <div class="symbol-label">
                              <span class="svg-icon svg-icon-md svg-icon-success"><!--begin::Svg Icon | path:assets/media/svg/icons/General/Notification2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            if (!$row) { ?>
               ...
               <div class="offcanvas-content pr-5 mr-n5">
                  ...
                  <div class="d-flex align-items-center mt-5">
                     <div class="d-flex flex-column">
                        <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
                           <?php echo $_SESSION['applicant_id']; ?>
                        </a>
